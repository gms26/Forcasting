    ...
    <div className="dash-card p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="p-4 rounded-xl border border-gray-200 bg-gray-50 flex flex-col justify-between">
          ...
          <span className="text-[11px] text-gray-500 mt-1">Mean Absolute Error</span>
        </div>
        ...
        <div className="p-4 rounded-xl border border-gray-200 bg-gray-50 flex flex-col justify-between">
          ...
          <span className="text-[11px] text-gray-500 mt-1">Root Mean Square Error</span>
        </div>
        ...
        <div className="p-4 rounded-xl border border-emerald-200 bg-emerald-50/70 flex flex-col justify-between">
          ...
          <span className="text-[11px] text-emerald-700/80 mt-1">Percentage Loss</span>
        </div>
      </div>
    </div>
  );
